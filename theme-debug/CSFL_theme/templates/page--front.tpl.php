  ...
  <header id="header" class="clearfix">
    <div class="top_right">
      ...
      <div id="promo">
          ...
          <?php
			 //$menu = menu_navigation_links('menu-contact-menu');
			 //print theme('links__menu_menu-contact-menu', array('links' => $menu));
			?>
...
<div id="homepageIntroWrap">
    <div id="homepageIntro">
    <?php print render($page['homepage_st_first']) ?>
    <?php print render($page['homepage_st_second']) ?>
    <?php print render($page['homepage_st_third']) ?>
    </div>
</div>
...
<div id="page-wrap">
	...
	<div id="showcase">
		<?php print render($page['homepage_rollup_first']) ?>
		<?php print render($page['homepage_rollup_second']) ?>
        <?php print render($page['homepage_rollup_third']) ?>
    </div>
...
<div id="membersMap">
	<?php print render($page['homepage_members_map']) ?>
	<noscript>
	<div style="max-width:800px;margin:auto;">
	<em>The Member's Map is not viewable without JavaScript enabled</em>
	<p>The current members of the CSLF are Australia, Brazil, Canada, China, the Czech Republic, the European Commission, France, Germany, Greece, India, Italy, Japan, Korea, Mexico, Netherlands, New Zealand, Norway, Poland, Romania, Russia, Saudi Arabia, Serbia, South Africa, United Arab Emirates, United Kingdom, and the United States.</p>
	</div>
	<style type="text/css">
	#vmap {display:none;}
	</style>
...
<div id="footer">
  ...
  <?php if ($page['footer_first'] || $page['footer_second']): ?> 
    <div id="footer-area" class="full-wrap clearfix">
      ...
      <div class="column two"><?php print render($page['footer_second']); ?>      
